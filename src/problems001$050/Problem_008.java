...
/**
 * Problem_008.
 * Calculate (user input) adjacent's numbers greatest product
 * of a 1000digit number
 * @author Yevhen
 *
 */
public class Problem_008 {
    ...
    public static void main(String arg[])
    {
        ...
        for (int i = 0; i < (999 - userInt); i++)
        {
            tempProduct = 1;
            shortCount = 0;
            while (shortCount < userInt)
            {
                tempChar = LARGE_NUMBER.charAt(i + shortCount); 
