...
public class Problem_051 {
     ...
     */
    private static String[] famCount(int victim) {
        String[] outList = {"",""};
    ...
    public static void main(String[] args) {
        ...
        for (int i = 11; num != 8; i+=2){
            if (isPrime(i)){
                num = Integer.valueOf(famCount(i)[0]);
                patern = famCount(i)[1];
                start = i;
            }
        }
        System.out.println("First prime is: " + compNum(patern, start, 1) 
        + " with pattern " + patern + "0");
    }
}
